...
public class ApplicationContext {
    ...
    public DataSource dataSource() {
        ...
        try {
            ...
            LOGGER.warn(String.format("EXITO CONECTANDOSE A DB %s", catalog));
        } catch (SQLException e) {
            LOGGER.error(String.format("NO SE PUDO CONNECTAR A LA DB %s", PROPERTY_NAME_DATABASE_URL), e);
        }

        LOGGER.info(String.format("Init dataSource %s", dataSource));
        return dataSource;
    }
    ...
    public JpaTransactionManager transactionManager() throws ClassNotFoundException {
        ...
        LOGGER.info(String.format("Init transactionManager %s", transactionManager));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() throws ClassNotFoundException {
        ...
        LOGGER.info(String.format("Init entityManagerFactory %s", entityManagerFactoryBean));
